...
export const Buy = () => {
    ...
    const getProducts = async () => {
        try{
            const { data } = await axios('http://localhost:3200/publication/getPublications');
    ...
    const getProductsNoUser = async () => {
        try{
            console.log('hola' + dataUser.id);
            const { data } = await axios(`http://localhost:3200/publication/getNoUser/${dataUser.id}`);
            setPublication(data.publications);
        }catch(err){
            console.log(err);
        }
