...
export const Profile = () => {
    ...
    const getProducts = async () => {
        try{
            const { data } = await axios(`http://localhost:3200/publication/getPublicationsByUser/${dataUser.id}`);
    ...
    const getSold = async () => {
        try{
            const { data } = await axios(`http://localhost:3200/history/getSold/${dataUser.id}`);
    ...
    const getBought = async () => {
        try{
            const { data } = await axios(`http://localhost:3200/history/getBought/${dataUser.id}`);
